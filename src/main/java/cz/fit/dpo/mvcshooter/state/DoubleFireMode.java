 ...
 */
public class DoubleFireMode implements FireMode {
    public List<Missile> shoot(Cannon cannon, int gravity, Factory factory) {
        ...
        missiles.add(factory.makeMissile(cannon.getX() + Config.MISSILE_INIT_DISTANCE_FROM_CANNON, cannon.getY(), cannon.getForce(), cannon.getAngle() + 10, gravity));
